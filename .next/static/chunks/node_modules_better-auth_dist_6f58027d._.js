        ...
        getActions: ($fetch)=>({
                ...
                organization: {
                    checkRolePermission: (data)=>{
                        const isAuthorized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$OuYYTHC7$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"])({
                            role: data.role,
                            options: {
                                ac: options?.ac,
                                roles
...
async function setCookieCache(ctx, session) {
    ...
    if (shouldStoreSessionDataInCookie) {
        ...
        const data = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$base64$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["base64Url"].encode(JSON.stringify({
            session: sessionData,
            expiresAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CW6D9eSx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx.context.authCookies.sessionData.options.maxAge || 60, "sec").getTime(),
...
const getSessionCookie = (request, config)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$VTXNLFMT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])(req?.url, config?.path, req);
...
const getCookieCache = (request, config)=>{
    ...
    const name = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$8zoxzg$2d$F$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"] ? `__Secure-${cookiePrefix}.${cookieName}` : `${cookiePrefix}.${cookieName}`;
    const parsedCookie = parseCookies(cookies);
    const sessionData = parsedCookie.get(name);
    if (sessionData) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$tB5eU6EY$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"])(sessionData);
    }
    return null;
};
;
}}),
"[project]/node_modules/better-auth/dist/social-providers/index.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getApplePublicKey = async (kid)=>{
    ...
    const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(`${APPLE_BASE_URL}${JWKS_APPLE_URI}`);
    if (!data?.keys) {
...
const facebook = (options)=>{
    return {
        ...
        async createAuthorizationURL ({ state, scopes, redirectURI, loginHint }) {
            ...
            options.scope && _scopes.push(...options.scope);
            scopes && _scopes.push(...scopes);
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DufyW0qf$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])({
                id: "facebook",
                options,
    ...
    return {
        ...
        async createAuthorizationURL ({ state, scopes, codeVerifier, redirectURI, loginHint, display }) {
            if (!options.clientId || !options.clientSecret) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Cqykj82J$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["l"].error("Client Id and Client Secret is required for Google. Make sure to provide them in the options.");
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(`https://graph.microsoft.com/v1.0/me/photos/${profilePhotoSize}x${profilePhotoSize}/$value`, {
                ...
                async onResponse (context) {
                    ...
                    try {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Cqykj82J$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["l"].error(e && typeof e === "object" && "name" in e ? e.name : "", e);
                    }
                }
            });
            const userMap = await options.mapProfileToUser?.(user);
...
const twitch = (options)=>{
    return {
        ...
        async getUserInfo (token) {
            ...
            if (!idToken) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Cqykj82J$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["l"].error("No idToken found in token");
                return null;
            }
...
const dropbox = (options)=>{
    ...
    return {
        ...
        validateAuthorizationCode: async ({ code, codeVerifier, redirectURI })=>{
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DufyW0qf$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"])({
                code,
                codeVerifier,
                redirectURI,
                options,
...
const tiktok = (options)=>{
    return {
        ...
        async getUserInfo (token) {
            ...
            const { data: profile, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(`https://open.tiktokapis.com/v2/user/info/?fields=${fields.join(",")}`, {
                headers: {
                    authorization: `Bearer ${token.accessToken}`
                }
            });
...
const reddit = (options)=>{
    return {
        ...
        validateAuthorizationCode: async ({ code, redirectURI })=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DufyW0qf$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"])(data);
        },
        refreshAccessToken: options.refreshAccessToken ? options.refreshAccessToken : async (refreshToken)=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DufyW0qf$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"])({
                refreshToken,
...
const zoom = (userOptions)=>{
    ...
    return {
        ...
        createAuthorizationURL: async ({ state, redirectURI, codeVerifier })=>{
            ...
            if (options.pkce) {
                const codeChallenge = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DufyW0qf$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(codeVerifier);
...
const SocialProviderListEnum = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$dist$2f$esm$2f$v3$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum(socialProviderList, {
...
;
;
const signUpEmail = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/sign-up/email", {
        method: "POST",
        ...
        if (!isValidEmail.success) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                message: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"].INVALID_EMAIL
            });
        }
        ...
        if (password.length < minPasswordLength) {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                message: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"].PASSWORD_TOO_SHORT
            });
        }
        ...
        if (password.length > maxPasswordLength) {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                message: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"].PASSWORD_TOO_LONG
            });
        }
        ...
        if (dbUser?.user) {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("UNPROCESSABLE_ENTITY", {
                message: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"].USER_ALREADY_EXISTS
            });
        }
        const additionalData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Cc72UxUH$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["f"])(ctx.context.options, additionalFields);
        ...
        if (ctx.context.options.emailVerification?.sendOnSignUp || ctx.context.options.emailAndPassword.requireEmailVerification) {
            const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"])(ctx.context.secret, createdUser.email, void 0, ctx.context.options.emailVerification?.expiresIn);
...
async function onRequestRateLimit(req, ctx) {
    ...
    const ip = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$iKoUsdFE$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(req, ctx.options);
    if (!ip) {
        return;
    }
    const key = ip + path;
    ...
    if (ctx.rateLimit.customRules) {
        const _path = Object.keys(ctx.rateLimit.customRules).find((p)=>{
            if (p.includes("*")) {
                const isMatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["w"])(p)(path);
                return isMatch;
            }
            return p === path;
        });
...
function toAuthEndpoints(endpoints, ctx) {
    ...
    for (const [key, endpoint] of Object.entries(endpoints)){
        api[key] = async (context)=>{
            ...
            if (result.response instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"] && !context?.asResponse) {
                throw result.response;
            }
            const response = context?.asResponse ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toResponse"])(result.response, {
...
function getEndpoints(ctx, options) {
    ...
    const baseEndpoints = {
        signInSocial: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["N"],
        callbackOAuth: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["M"],
        getSession: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"])(),
        signOut: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["L"],
        signUpEmail: signUpEmail(),
        signInEmail: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["K"],
        forgetPassword: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["J"],
        resetPassword: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["I"],
        verifyEmail: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["G"],
        sendVerificationEmail: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["F"],
        changeEmail: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["E"],
        changePassword: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["D"],
        setPassword: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"],
        updateUser: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["u"])(),
        deleteUser: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["A"],
        forgetPasswordCallback: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"],
        listSessions: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["l"])(),
        revokeSession: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["y"],
        revokeSessions: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["x"],
        revokeOtherSessions: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"],
        linkSocialAccount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"],
        listUserAccounts: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["q"],
        deleteUserCallback: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"],
        unlinkAccount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"],
        refreshToken: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"],
        getAccessToken: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"]
    };
    const endpoints = {
        ...baseEndpoints,
        ...pluginEndpoints,
        ok: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["k"],
        error: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["j"]
    };
...
const router = (ctx, options)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRouter"])(api, {
        ...
        routerMiddleware: [
            {
                path: "/**",
                middleware: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dvh$2d$YFwT$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["i"]
            },
            ...middlewares
        ],
        async onRequest (req) {
        ...
        onError (e) {
            ...
            const log = optLogLevel === "error" || optLogLevel === "warn" || optLogLevel === "debug" ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Cqykj82J$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["l"] : void 0;
...
async function compareHash(data, hash) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$OT3XFeFk$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(buffer, hashBuffer);
}
...
//# sourceMappingURL=node_modules_better-auth_dist_6f58027d._.js.map